...
class MoEBlockForOnnxExport(torch.autograd.Function):
    ...
    @staticmethod
    def symbolic(g: torch.Graph, hidden_states, router_logits, batch_size, sequence_length, hidden_dim, top_k, num_experts, hidden_act, expert_weights_1, expert_weights_2, expert_weights_3):
        final_hidden_states = g.op("com.microsoft::MoE", hidden_states, router_logits, expert_weights_1, expert_weights_2, expert_weights_3)
